...
void DigitLedDisplay::tableChar(byte address, char c) 
{
	...
	switch(c)
	{
		...
		case 'c':
		case 'C': offs = 12; break;
		case 'D':
		case 'd': offs = 13; break;
		case 'e':
		case 'E': offs = 14; break;
		case 'f':
		case 'F': offs = 15; break;
		case 'g':
		case 'G': offs = 16; break;
		case 'h':
		case 'H': offs = 17; break;
		case 'i':
		case 'I': offs = 18; break;
		case 'j':
		case 'J': offs = 19; break;
		case 'k':
		case 'K': offs = 20; break; 
		case 'l':
		case 'L': offs = 21; break;
		case 'm':
		case 'M': offs = 22; break; 
		case 'N':
		case 'n': offs = 23; break;
		case 'o':
		case 'O': offs = 24; break;
		case 'p':
		case 'P': offs = 25; break;
		case 'Q':	
		case 'q': offs = 26; break;
		case 'R':
		case 'r': offs = 27; break;
		case 's':
		case 'S': offs = 28; break;
		case 'T':
		case 't': offs = 29; break;
		case 'u':
		case 'U': offs = 30; break;
		case 'v':
		case 'V': offs = 31; break;  
		case 'w':
		case 'W': offs = 32; break;  
		case 'x':
		case 'X': offs = 33; break;  
		case 'Y':
		case 'y': offs = 34; break;
		case 'z':
		case 'Z': offs = 45; break;  
		case ' ': offs = 36; break;  
		case '-': offs = 37; break;  
		case '.': offs = 38; break;  
		case '*': offs = 39; break; 
		case '_': offs = 40; break; 		
		default: offs = 36; break;
	}
